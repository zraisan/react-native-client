...
/**
 * Represents the JavaScript callback `(bytesWritten: number, contentLength: number) => void`.
...
fun interface Func_void_double_double: (Double, Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(bytesWritten: Double, contentLength: Double): Unit
}
...
class Func_void_double_double_cxx: Func_void_double_double {
  ...
  @Keep
  override fun invoke(bytesWritten: Double, contentLength: Double): Unit
    = invoke_cxx(bytesWritten,contentLength)

  @FastNative
  private external fun invoke_cxx(bytesWritten: Double, contentLength: Double): Unit
}
...
class Func_void_double_double_java(private val function: (Double, Double) -> Unit): Func_void_double_double {
  ...
  @Keep
  override fun invoke(bytesWritten: Double, contentLength: Double): Unit {
    return this.function(bytesWritten, contentLength)
  }
}
